...
-- NOTE: Custom Key Mapppings for Terminal
...
-- make the block cursor constant and not blinking
vim.opt.guicursor = 'n-v-c-i:block-Cursor/block-Cursor'
...
-- NOTE: Custom Keys from ThePrimeagen Above ^
vim.g.mapleader = ' '
vim.g.maplocalleader = ' '

-- vim.keymap.set('n', '<leader>gr', ':LiveGrepGitRoot<cr>', { desc = '[S]earch by [G]rep on Git Root' })
...
require('lazy').setup({
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      -- NOTE: Obsidian autocmd
      -- local vault_location = '~/Volumes/JoeysExternalHard/ObsidianSync/*.md'
      -- local group = vim.api.nvim_create_augroup('obsidian_cmds', { clear = true })
      -- vim.api.nvim_create_autocmd('BufAdd', {
      --  command = 'ObsidianOpen',
